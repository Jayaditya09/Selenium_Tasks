...
//		driver.manage().window().maximize();
		...
		txtscearch.sendKeys("hp laptop",Keys.ENTER);
		Thread.sleep(1000);
		WebElement webElement = driver.findElement(By.xpath("//a[contains(text(),'HP 15s Ryzen 3 Dual Core 3250U - (8 GB/1 TB HDD/Windows...')]"));
		webElement.click();
