...
public class Question_No_06 {
	...
	public static void main(String[] args) {
		...
		WebElement mov2 = driver.findElement(By.xpath("//span[text()='Software Testing (12)']"));
		
		ac.moveToElement(mov2).perform();
		
		WebElement btnsel = driver.findElement(By.xpath("//span[text()='Selenium Certification Training']"));
